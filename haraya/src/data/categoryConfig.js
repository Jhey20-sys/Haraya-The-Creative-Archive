...
const categories = [
  ...
  {
    id: 'd8a8b8c8-8888-4888-a888-888888888888',
    slug: 'digital-art',
    name: 'Digital Art',
  ...
  },
  {
    ...
    slug: 'traditional-dawing',
    name: 'Traditional Drawing',
    description: 'Ink drawings created from random thoughts and fleeting ideas.',
    expanded_description: 'A collection of spontaneous ink drawings created from random thoughts and fleeting ideas. Each piece captures a moment of imagination expressed through simple lines and a single pen.',
    icon: '✍️',
    gradient: 'from-brown-soft/60 to-brown/60',
    mediaType: 'image',
    hryRef: 'HRY–05',
    refName: 'Traditional Drawing',
    iconText: 'Dr',
  },
  {
